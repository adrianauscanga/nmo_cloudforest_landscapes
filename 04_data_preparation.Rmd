...
Add 'sites' data on land-use to the 'plot_cf' dataset

```{r}
sites_cf %>%
  select(site, subregion, agriculture, grazing) %>%
  mutate(site = as.numeric(site)) %>%
  right_join(plots_cf, by = "site") %>%
  relocate(c("agriculture", "grazing"), .after = str_class_plots) -> plots_cf
