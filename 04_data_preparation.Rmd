...
ggdensity(sites_cf2$t_shannon_av_site)

#qqplot
ggqqplot(sites_cf2$av_agb_site)
ggqqplot(sites_cf2$t_shannon_av_site)
```
...
shapiro.test(plots_cf$sp_richness_plot) 
shapiro.test(plots_cf$t_shannon) 
...
ggdensity(plots_cf$sp_richness_plot) 
ggdensity(plots_cf$t_shannon)
...
shapiro.test(sites_cf2$t_shannon_av_site) # normal p = 0.60
