...
aspect <- read_csv("input/aspect_plots.csv", col_names = F) #Change this file to input directory!!!!!

slope <- read_csv("input/slope_plots.csv", col_names = F) #Change this file to input directory!!!!!
