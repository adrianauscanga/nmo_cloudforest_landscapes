...
# Repeat with a subset of 180 plots (for the sites that have 4 plots each)
...
plots_cf_4p <- sites_cf_4p %>%
  select(site) %>%
  left_join(plots_cf, by ="site") 

plots_str <- plots_cf_4p %>%
  select(plot_id,
         tree_density,
         loreys_height,
         basal_area_ha,
...
# Scale data so that variables in different units can be compared
plots_str_scaled <- scale(plots_str[,-c(1,2,6)])
row.names(plots_str_scaled) <- plots_str$plot_id
...
plots_cf_4p %>%
  ggplot(aes(x = tree_density, group = str_class_plots_4p, fill = str_class_plots_4p, color = str_class_plots_4p)) +
  geom_density(alpha= 0.5) +
  scale_fill_manual(values = c("tomato", "green3", "dodgerblue2")) +
  scale_color_manual(values = c("tomato", "green3", "dodgerblue2")) +
  ggtitle("Tree density")
...
plots_cf_4p %>%
  ggplot(aes(x = loreys_height, group = str_class_plots_4p, fill = str_class_plots_4p, color = str_class_plots_4p)) +
  geom_density(alpha= 0.5) +
  scale_fill_manual(values = c("tomato", "green3", "dodgerblue2")) +
  scale_color_manual(values = c("tomato", "green3", "dodgerblue2")) +
  ggtitle("Tree height")
...
plots_cf_4p %>%
  ggplot(aes(x = basal_area_ha, group = str_class_plots_4p, fill = str_class_plots_4p, color = str_class_plots_4p)) +
  geom_density(alpha= 0.5) +
  scale_fill_manual(values = c("tomato", "green3", "dodgerblue2")) +
  scale_color_manual(values = c("tomato", "green3", "dodgerblue2")) +
  ggtitle("Basal area")
...
# Plots with 4 repetitions

plots_cf_4p %>%
  ggplot(aes(y = tree_density, color = str_class_plots_4p)) +
  geom_boxplot()

plots_cf_4p %>%
  ggplot(aes(y = loreys_height, color = str_class_plots_4p)) +
  geom_boxplot()

plots_cf_4p %>%
  ggplot(aes(y = basal_area_ha, color = str_class_plots_4p)) +
  geom_boxplot()

plots_cf_4p %>%
  ggplot(aes(y = agb_plot_ha, color = str_class_plots_4p)) +
  geom_boxplot()

plots_cf_4p %>%
  ggplot(aes(y = shannon, color = str_class_plots_4p)) +
  geom_boxplot()

plots_cf_4p %>%
  ggplot(aes(y = t_shannon, color = str_class_plots_4p)) +
  geom_boxplot()
```
...
# First, let's add agriculture and grazing data to the plots dataset

sites_cf_4p %>%
  select(site, agriculture, grazing) %>%
  right_join(plots_cf_4p, by ="site") %>%
  relocate(c("agriculture", "grazing"), .after = str_class_plots_4p) -> plots_cf_4p
...
sites_cf %>%
  ...
  relocate(c("agriculture", "grazing"), .after = sp_richness_plot) -> plots_cf
```
