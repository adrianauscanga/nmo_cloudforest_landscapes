...
Moran test shows that there's spatial autocorrelation among sites that are 10 km apart.
To account for this spatial autocorrelation, I'll cluster the data in subregions.
Fortunately, Toledo-Aceves et al (2011) already divided the NMO region in smaller subregions, which fit pretty well with the network of neighbors.

Add a column with subregions
