...
pca_scores_plots %>%
  ...
  geom_text(aes(x= -1.95, y= 1.9, label = "Stem density"),
            color = "gray75",
            size = 3) +
  geom_segment(aes(x = 0, y = 0, xend = -2.1, yend =  -1.4),
               color = "gray50",
               arrow = arrow(length = unit(0.2,"cm"))) +
  geom_text(aes(x= -2.2, y= -1.5, label = "Lorey's height"),
            color = "gray75",
            size = 3) +
  geom_segment(aes(x = 0, y = 0, xend = -2.5, yend = -0.1),
               color = "gray50",
               arrow = arrow(length = unit(0.2,"cm"))) +
  geom_text(aes(x= -2.5, y= -0.2, label = "Basal area"),
            color = "gray75",
            size = 3)
...
## Figure 5.  Regressions between AGB and env_pc1 and land-use intensity and env_pc1
