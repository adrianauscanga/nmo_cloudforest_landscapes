...
f4a <- fig4_df %>%
  ggplot(aes(x = tree_density, y = agb_plot_ha))  +
  geom_point(aes(color = factor(forest_classification, levels = c('undisturbed', 'regrowth', 'degraded', 'deforested'),ordered = TRUE)),
             size = 2, alpha = 0.75) +
  scale_color_manual(values = c("#1b9e77", "#7570b3", "#e7298a", "#d95f02")) +
  geom_smooth(method = "lm", span= 0.9, color = "gray20", se = F, linetype = "solid", size = 0.75, alpha= 0.3) +
  ...
  annotate("text", x = 400, y = 1000, label = "Adjusted R-squared:  0.332", size = 3.3)
  
summary(lm(log1p(fig4_df$agb_plot_ha) ~ fig4_df$tree_density))

f4b <- fig4_df %>%
  ggplot(aes(x = basal_area_ha, y = agb_plot_ha))  +
  geom_point(aes(color = factor(forest_classification, levels = c('undisturbed', 'regrowth', 'degraded', 'deforested'),ordered = TRUE)),
             size = 2, alpha = 0.75) +
  scale_color_manual(values = c("#1b9e77", "#7570b3", "#e7298a", "#d95f02")) +
  geom_smooth(method = "lm", span=1, color = "gray20", se = F, linetype = "solid", size = 0.75, alpha= 0.3) +
  theme_classic() +
  ...
  scale_y_continuous(trans = "log1p",
                     limits = c(0,1000),
                     breaks = c(0,100,500,1000)) +
  annotate("text", x = 20, y = 1000, label = "Adjusted R-squared:  0.721", size = 3.3)

summary(lm(log1p(fig4_df$agb_plot_ha) ~ fig4_df$basal_area_ha))

f4c <- fig4_df %>%
  ggplot(aes(x = loreys_height, y = agb_plot_ha))  +
  geom_point(aes(color = factor(forest_classification, levels = c('undisturbed', 'regrowth', 'degraded', 'deforested'),ordered = TRUE)),
             size = 2, alpha = 0.75) +
  scale_color_manual(values = c("#1b9e77", "#7570b3", "#e7298a", "#d95f02")) +
  ...
  scale_y_continuous(trans = "log1p",
                     limits = c(0,1000),
                     breaks = c(0,100,500,1000)) +
  annotate("text", x = 5, y = 1000, label = "Adjusted R-squared:  0.525", size = 3.3)

summary(lm(log1p(fig4_df$agb_plot_ha) ~ fig4_df$loreys_height))

f4f <- fig4_df %>%
  ggplot(aes(x = ave_wd, y = agb_plot_ha))  +
  geom_point(aes(color = factor(forest_classification, levels = c('undisturbed', 'regrowth', 'degraded', 'deforested'),ordered = TRUE)),
             size = 2, alpha = 0.75) +
  scale_color_manual(values = c("#1b9e77", "#7570b3", "#e7298a", "#d95f02")) +
  geom_smooth(method = "lm", span=1, color = "gray20", se = F, linetype = "solid", size = 0.75, alpha= 0.3) +
  ...
  scale_y_continuous(trans = "log1p",
                     limits = c(0,1000),
                     breaks = c(0,100,500,1000)) +
  annotate("text", x = 0.35, y = 1000, label = "Adjusted R-squared:  0.17", size = 3.3)

summary(lm(log1p(fig4_df$agb_plot_ha) ~ fig4_df$ave_wd))
