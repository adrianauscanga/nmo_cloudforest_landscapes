...
ggplot(dend_data$segments) + 
  ...
  geom_text(data = dend_labels, aes(x, y = -1, label = label), hjust = 1, angle = 90, size = 3) +
  ylim(-3, 20) +
  ...
  geom_rect(data = rect, mapping= aes(xmin = x1, xmax = x2, ymin = y1, ymax = y2), fill = NA, color = "gray50", linetype = 3, size = 0.2) +
  theme_classic()
